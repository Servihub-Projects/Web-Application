...
export default function HeroSection() {
  return (
    <section className="bg-linear-to-b from-orange-50 to-blue-50 overflow-hidden">
      <div className="container px-4 mx-auto py-16 flex gap-12">
        <div className="md:flex-1 min-w-0">
          ...
          <h1 className="text-5xl md:text-7xl text-slate-800 mb-6 font-500">Your Global Marketplace for <span className="bg-clip-text text-transparent bg-linear-to-r from-orange-500 to-orange-700">Professional</span> <span className="bg-clip-text text-transparent bg-linear-to-r from-orange-700 to-blue-900">Services</span></h1>
        ...
        <div className="hidden flex-1 md:flex justify-center items-center">
          <div className="w-full max-w-[480px] aspect-square rounded-lg bg-white p-1">
